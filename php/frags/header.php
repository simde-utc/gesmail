  ...
  <body>
    <div class="container-fluid">
      <div class="navbar navbar-fixed-top d-flex flex-column flex-md-row">
          <button id="toggleMenuButton" type="button" class="btn btn-default d-block d-md-none position-absolute" data-toggle="collapse" data-target="#demo" style="left: 0;margin-top: 4%;">
    ...
    <div class="container-fluid overflow-auto">
      <!-- Left block (menu) d-none d-md-block -->
      <div class="row">
        <div class="col-md-2 d-none d-md-block" id="leftMenu">
